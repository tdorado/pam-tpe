...
class Charge : Serializable, GroupHistory {
    ...
    constructor(id: Long, title: String?, owner: ApplicationUser?, debtors: MutableSet<ApplicationUser?>?, amount: Double, date: Date?) {
        this.id = id
        this.title = title
        this.owner = owner
    ...
    constructor(title: String?, owner: ApplicationUser?, debtors: MutableSet<ApplicationUser?>?, amount: Double, date: Date?) {
        this.title = title
        this.owner = owner
        this.debtors = debtors
        this.amount = amount
    ...
    fun getDebtors(): MutableSet<ApplicationUser?>? {
        return debtors
    }

    fun setDebtors(debtors: MutableSet<ApplicationUser?>?) {
        this.debtors = debtors
    }
