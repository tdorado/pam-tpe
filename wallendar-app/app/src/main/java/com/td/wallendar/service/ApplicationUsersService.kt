...
interface ApplicationUsersService {
    ...
    open fun authenticateUser(@Body loginRequest: LoginRequest?): Single<Response<LoginResponse?>?>?
    @POST("/api/users/create")
    open fun createUser(@Body addApplicationUserRequest: AddApplicationUserRequest?): Single<Response<ApplicationUserResponse?>?>?
    @GET("/api/users/{id}")
    open fun getUser(@Path("id") userId: Long): Single<Response<ApplicationUserResponse?>?>?
    @GET("/api/users/findByEmail")
    open fun getUserByEmail(@Query("email") email: String?): Single<Response<ApplicationUserResponse?>?>?
    @POST("/api/user/{id}/createAlias")
    open fun createAlias(@Path("id") userId: Long, @Body addUserAliasRequest: AddUserAliasRequest?): Single<Response<UserAliasResponse?>?>?
    @GET("/api/users/{id}/getAliases")
    open fun getUserAliases(@Path("id") userId: Long): Single<Response<MutableList<UserAliasResponse?>?>?>?
}