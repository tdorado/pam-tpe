...
class GroupResponse {
    ...
    private var owner: ApplicationUserResponse? = null
    private var members: MutableSet<ApplicationUserResponse?>? = null
    private var charges: MutableSet<ChargeResponse?>? = null
    private var debts: MutableSet<DebtResponse?>? = null
    private var payments: MutableSet<PaymentResponse?>? = null

    constructor(id: Long, title: String?, owner: ApplicationUserResponse?, members: MutableSet<ApplicationUserResponse?>?, charges: MutableSet<ChargeResponse?>?, debts: MutableSet<DebtResponse?>?, payments: MutableSet<PaymentResponse?>?) {
        this.id = id
        this.title = title
        this.owner = owner
    ...
    fun getOwner(): ApplicationUserResponse? {
        return owner
    }

    fun setOwner(owner: ApplicationUserResponse?) {
        this.owner = owner
    }

    fun getMembers(): MutableSet<ApplicationUserResponse?>? {
        return members
    }

    fun setMembers(members: MutableSet<ApplicationUserResponse?>?) {
        this.members = members
    }

    fun getCharges(): MutableSet<ChargeResponse?>? {
        return charges
    }

    fun setCharges(charges: MutableSet<ChargeResponse?>?) {
        this.charges = charges
    }

    fun getDebts(): MutableSet<DebtResponse?>? {
        return debts
    }

    fun setDebts(debts: MutableSet<DebtResponse?>?) {
        this.debts = debts
    }

    fun getPayments(): MutableSet<PaymentResponse?>? {
        return payments
    }

    fun setPayments(payments: MutableSet<PaymentResponse?>?) {
        this.payments = payments
    }
}