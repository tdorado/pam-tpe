...
class AddMembersPresenter(addMembersView: AddMembersView?, groupsRepository: GroupsRepository?, schedulerProvider: SchedulerProvider?) {
    private val view: WeakReference<AddMembersView?>?
    ...
    init {
        view = WeakReference(addMembersView)
