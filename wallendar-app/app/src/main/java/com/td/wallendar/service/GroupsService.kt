...
interface GroupsService {
    ...
    open fun getGroupsByUserId(@Path("userId") userId: Long): Single<Response<MutableList<GroupResponse?>?>?>?
    @GET("/api/groups/{groupId}")
    open fun getGroupById(@Path("groupId") groupId: Long): Single<Response<GroupResponse?>?>?
    @POST("/api/groups/create")
    open fun createGroup(@Body addGroupRequest: AddGroupRequest?): Single<Response<GroupResponse?>?>?
    @POST("/api/groups/{groupId}/addMemberByEmail")
    open fun addMemberByEmail(@Path("groupId") groupId: Long, @Body addMemberByEmailRequest: AddMemberByEmailRequest?): Single<Response<GroupResponse?>?>?
    @POST("/api/groups/{groupId}/addMembers")
    open fun addMembers(@Path("groupId") groupId: Long, @Body addMembersRequest: AddMembersRequest?): Single<Response<GroupResponse?>?>?
    @POST("/api/groups/{groupId}/addPayment")
    open fun addPayment(@Path("groupId") groupId: Long, @Body addPaymentRequest: AddPaymentRequest?): Single<Response<GroupResponse?>?>?
}