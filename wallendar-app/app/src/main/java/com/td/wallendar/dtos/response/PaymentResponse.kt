...
class PaymentResponse {
    ...
    private var from: ApplicationUserResponse? = null
    private var to: ApplicationUserResponse? = null
    private var amount = 0.0
    private var date: Date? = null
    private var groupId: Long = 0

    constructor(id: Long, from: ApplicationUserResponse?, to: ApplicationUserResponse?, amount: Double, date: Date?, groupId: Long) {
        this.id = id
        this.from = from
        this.to = to
        this.amount = amount
    ...
    fun getFrom(): ApplicationUserResponse? {
        return from
    }

    fun setFrom(from: ApplicationUserResponse?) {
        this.from = from
    }

    fun getTo(): ApplicationUserResponse? {
        return to
    }

    fun setTo(to: ApplicationUserResponse?) {
        this.to = to
    }
