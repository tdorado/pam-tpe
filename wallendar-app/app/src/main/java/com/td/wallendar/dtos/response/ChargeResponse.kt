...
class ChargeResponse {
    ...
    private var debtors: MutableSet<ApplicationUserResponse?>? = null
    private var amount = 0.0
    private var date: Date? = null

    constructor() {}
    constructor(id: Long, title: String?, owner: ApplicationUserResponse?, debtors: MutableSet<ApplicationUserResponse?>?, amount: Double, date: Date?) {
        this.id = id
        this.title = title
        this.owner = owner
    ...
    fun getDebtors(): MutableSet<ApplicationUserResponse?>? {
        return debtors
    }

    fun setDebtors(debtors: MutableSet<ApplicationUserResponse?>?) {
        this.debtors = debtors
    }
