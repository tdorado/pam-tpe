...
class AddPaymentRequest(private var fromUserId: Long, private var toUserId: Long, private var amount: Double) {
    fun getFromUserId(): Long {
        return fromUserId
    }
    ...
    fun getToUserId(): Long {
        return toUserId
    }

    fun setToUserId(toUserId: Long) {
