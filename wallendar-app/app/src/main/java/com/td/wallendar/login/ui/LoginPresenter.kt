...
class LoginPresenter(loginView: LoginView?, applicationUsersRepository: ApplicationUsersRepository?, schedulerProvider: SchedulerProvider?) {
    private val loginView: WeakReference<LoginView?>?
    ...
    init {
        this.loginView = WeakReference(loginView)
