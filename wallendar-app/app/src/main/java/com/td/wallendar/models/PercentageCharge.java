...
public class PercentageCharge extends Charge {
    ...
    public PercentageCharge(final Long id, final User owner, final String title, final List<User> debtors,
                            final double amount, final Map<User, Double> percentagePerUser,
                            final Date date) {
        super(id, owner, title, ChargeType.PERCENTAGE, debtors, amount, date);
        this.percentagePerUser = percentagePerUser;
    }

    public PercentageCharge() {
