...
class Group : Serializable {
    ...
    private var owner: ApplicationUser? = null
    private var members: MutableSet<ApplicationUser?>? = null
    private var charges: MutableSet<Charge?>? = null
    private var debts: MutableSet<Debt?>? = null
    private var payments: MutableSet<Payment?>? = null

    constructor() {}
    constructor(id: Long, title: String?, owner: ApplicationUser?, members: MutableSet<ApplicationUser?>?, charges: MutableSet<Charge?>?, debts: MutableSet<Debt?>?, payments: MutableSet<Payment?>?) {
        this.id = id
        this.title = title
        this.owner = owner
    ...
    fun getOwner(): ApplicationUser? {
        return owner
    }

    fun setOwner(owner: ApplicationUser?) {
        this.owner = owner
    }

    fun getMembers(): MutableSet<ApplicationUser?>? {
        return members
    }

    fun setMembers(members: MutableSet<ApplicationUser?>?) {
        this.members = members
    }

    fun getCharges(): MutableSet<Charge?>? {
        return charges
    }

    fun setCharges(charges: MutableSet<Charge?>?) {
        this.charges = charges
    }

    fun getDebts(): MutableSet<Debt?>? {
        return debts
    }

    fun setDebts(debts: MutableSet<Debt?>?) {
        this.debts = debts
    }

    fun getPayments(): MutableSet<Payment?>? {
        return payments
    }

    fun setPayments(payments: MutableSet<Payment?>?) {
        this.payments = payments
    }
}