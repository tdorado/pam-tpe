...
class AddApplicationUserRequest(private var email: String?, private var password: String?, private var firstName: String?, private var lastName: String?, private val phoneNumber: String?) {
    fun getEmail(): String? {
        return email
    }
