...
class Payment(private var id: Long, private var from: ApplicationUser?, private var to: ApplicationUser?, private var amount: Double, private var date: Date?) : Serializable, GroupHistory {
    override fun equals(o: Any?): Boolean {
        if (this === o) return true
        if (o == null || javaClass != o.javaClass) return false
        val payment = o as Payment?
    ...
    fun setFrom(from: ApplicationUser?) {
        this.from = from
    }

    fun getTo(): ApplicationUser? {
        return to
    }

    fun setTo(to: ApplicationUser?) {
        this.to = to
    }
