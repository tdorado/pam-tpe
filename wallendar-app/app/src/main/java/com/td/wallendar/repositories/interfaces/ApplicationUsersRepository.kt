...
interface ApplicationUsersRepository {
    open fun authenticateUser(loginRequest: LoginRequest?): Single<LoginResponse?>?
    open fun createUser(addApplicationUserRequest: AddApplicationUserRequest?): Single<ApplicationUser?>?
    open fun getUser(userId: Long): Single<ApplicationUser?>?
    open fun getUserByEmail(email: String?): Single<ApplicationUser?>?
    open fun createAlias(userId: Long, addUserAliasRequest: AddUserAliasRequest?): Single<UserAlias?>?
    open fun getUserAliases(userId: Long): Single<MutableList<UserAlias?>?>?
}