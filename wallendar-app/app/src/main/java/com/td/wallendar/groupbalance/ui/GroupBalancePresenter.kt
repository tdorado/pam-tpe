...
class GroupBalancePresenter(groupBalanceView: GroupBalanceView?, groupsRepository: GroupsRepository?, schedulerProvider: SchedulerProvider?) {
    private val groupBalanceView: WeakReference<GroupBalanceView?>?
    ...
    init {
        this.groupBalanceView = WeakReference(groupBalanceView)
