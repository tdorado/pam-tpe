...
class Debt(private var id: Long, private var from: ApplicationUser?, private var to: ApplicationUser?, private var amount: Double, private var groupId: Long) : Serializable {
