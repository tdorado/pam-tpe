...
interface HomeView {
    open fun showGroups()
    open fun showBalances()
    open fun showProfile()
    open fun bindGroups(groups: MutableList<Group?>?)
    open fun bindDebts(debts: MutableList<Debt?>?)
    open fun bindProfile(applicationUser: ApplicationUser?)
    open fun updateGroup(group: Group?)
    open fun removeDebt(debt: Debt?)
    open fun errorGettingUser()
    open fun errorGettingGroups()
    open fun errorGettingBalances()
    open fun errorPayingDebt()
}